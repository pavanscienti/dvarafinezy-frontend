! function(t) {
    ...
    "undefined" != typeof ko && ko.bindingHandlers && !ko.bindingHandlers.multiselect && (ko.bindingHandlers.multiselect = {
        ...
        defaults: {
            ...
            delimiterText: ", ",
            templates: {
                button: '<button type="button" class="multiselect dropdown-toggle btn-sm" data-toggle="dropdown" style="white-space:normal;text-align: left;"><span class="multiselect-selected-text" style="margin-right:15px;"></span> <b class="caret" style="margin-left:5px;position: absolute;right: 5px;top: 48%;"></b></button>',
