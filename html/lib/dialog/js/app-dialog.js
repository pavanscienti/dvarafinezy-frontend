! function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.AppDialog = t()
}(this, function() {
    "use strict";
    var e = {
            title: "",
        ...
        t = function(e) {
            var t = {};
            for (var n in e) t[e[n]] = "app-dialog-" + e[n];
            return t
        },
        n = t(["container", "shown", "iosfix", "modal", "overlay", "fade", "show", "hide", "noanimation", "close", "title", "titleStyle", "titleClass", "content", "spacer", "confirm", "cancel", "icon", "image", "input", "file", "range", "select", "radio", "checkbox", "textarea", "inputerror", "validationerror", "progresssteps", "activeprogressstep", "progresscircle", "progressline", "loading", "styled"]),
        ...
        a = function(e) {
            if ("undefined" == typeof document) return void console.error("AppDialog requires document to initialize");
            var t = document.createElement("div");
            t.className = n.container, t.innerHTML = l;
            var o = document.querySelector(e.target);
            o || (console.warn("AppDialog: Can't find the target \"" + e.target + '"'), o = document.body), o.appendChild(t);
            var r = u(),
                i = B(r, n.input),
                a = B(r, n.file),
        ...
        C = function(e) {
            var t = [g(), b()];
            return e && t.reverse(), t.concat(Array.prototype.slice.call(u().querySelectorAll("button:not([class^=app-dialog-]), input:not([type=hidden]), textarea, select")))
        },
        k = function(e, t) {
        ...
        W = function(t) {
            var r = u() || a(t);
            for (var i in t) e.hasOwnProperty(i) || "extraParams" === i || console.warn('AppDialog: Unknown parameter "' + i + '"');
            ...
            var l = p(),
                ...
                y = b(),
                C = w();
            if(t.titleClass) l.className += " " + t.titleClass;
            if(t.titleStyle){
                for(let styleName in t.titleStyle) {
                    l.style[styleName] += t.titleStyle[styleName];
                }
            }
            // Set content style
            if(t.contentClass) s.className += " " + t.contentClass;
            if(t.contentStyle){
                for(let styleName in t.contentStyle) {
                    s.style[styleName] += t.contentStyle[styleName];
                }
            }
            ...
            t.progressSteps.length ? (A(x), T(x), B >= t.progressSteps.length && console.warn("AppDialog: Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), t.progressSteps.forEach(function(e, o) {
            ...
            if (t.type) {
                ...
                if (!V) return console.error("AppDialog: Unknown alert type: " + t.type), !1;
        ...
        $ = function e() {
            ...
            if (void 0 === o[0]) return console.error("AppDialog expects at least 1 attribute!"), !1;
            var l = j({}, K);
            switch (N(o[0])) {
                case "string":
                ...
                case "object":
                    ...
                    break;
                default:
                    return console.error('AppDialog: Unexpected type of argument! Expected "string" or "object", got ' + N(o[0])), !1
            }
            W(l);
            var c = s(),
                d = u();
            return new Promise(function(t, o) {
                ...
                switch (l.input) {
                    ...
                    case null:
                        break;
                    default:
                        console.error('AppDialog: Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "' + l.input + '"')
                }
                "select" !== l.input && "radio" !== l.input || (l.inputOptions instanceof Promise ? (e.showLoading(), l.inputOptions.then(function(t) {
                    e.hideLoading(), F(t)
                })) : "object" === N(l.inputOptions) ? F(l.inputOptions) : console.error("AppDialog: Unexpected type of inputOptions! Expected object or Promise, got " + N(l.inputOptions))), R(l.animation, l.onOpen), l.allowEnterKey ? K(-1, 1) : document.activeElement && document.activeElement.blur(), s().scrollTop = 0, "undefined" == typeof MutationObserver || U || (U = new MutationObserver(e.recalculateHeight), U.observe(d, {
                    childList: !0,
                    characterData: !0,
                    subtree: !0
                }))
    ...
    return $.isVisible = function() {
        ...
        D = e;
        var t = function() {
                D = [], document.body.removeAttribute("data-app-dialog-queue-step")
            },
            n = [];
        return new Promise(function(e, o) {
            ! function r(i, a) {
                i < D.length ? (document.body.setAttribute("data-app-dialog-queue-step", i), $(D[i]).then(function(e) {
                    n.push(e), r(i + 1, a)
                }, function(e) {
                    t(), o(e)
                })) : (t(), e(n))
        ...
        return document.body.getAttribute("data-app-dialog-queue-step")
        ...
        if (!t || "object" !== (void 0 === t ? "undefined" : N(t))) return console.error("AppDialog: the argument for setDefaults() is required and has to be a object");
        for (var n in t) e.hasOwnProperty(n) || "extraParams" === n || (console.warn('AppDialog: Unknown parameter "' + n + '"'), delete t[n]);
        j(K, t)
