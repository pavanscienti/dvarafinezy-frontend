    ...
    $node.html([
        ...
        (options.title
            ? '    <div class="modal-header">' +
                '      <button type="button" class="close" onclick="$(this).closest(\'.modal\').modal(\'hide\')" aria-label="Close"><span aria-hidden="true">&times;</span></button>' +
...
var Toolbar = /** @class */ (function () {
    ...
    Toolbar.prototype.followScroll = function () {
        ...
        /*Comment out below line for Texteditor issues*/
       /* $toolbarWrapper.css({
